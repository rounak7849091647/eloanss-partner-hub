...
- [x] Generate a cohesive loan photography set
- [x] Build reusable loan imagery and guidance data
- [x] Upgrade the loan overview with filters, comparison, guidance, and FAQs
