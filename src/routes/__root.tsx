  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 font-display text-xl font-semibold text-navy">Page not found</h2>
  ...
  head: () => ({
    meta: [
      ...
      { title: "ELOANSS — Loans, Insurance & Investments" },
      {
        name: "description",
        content:
          "ELOANSS helps you compare loans and insurance from top banks, NBFCs and insurers with expert guidance and quick approvals.",
      },
      { name: "author", content: "ELOANSS" },
      { property: "og:site_name", content: "ELOANSS" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          name: "ELOANSS",
          description: "Loan broker, insurance facilitator and investment services.",
          url: "https://eloanss.com",
          areaServed: "IN",
        }),
      },
    ],
